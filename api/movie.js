...
router.post('/:movieId/postReview', function(req, res){
  ...
  let review=[parseInt(req.body.music), parseInt(req.body.vfx), parseInt(req.body.dialogue), parseInt(req.body.cinemetogrophy), parseInt(req.body.editing), parseInt(req.body.story), parseInt(req.body.acting), parseInt(req.body.originality), parseInt(req.body.atmosphere), parseInt(req.body.impact)];
